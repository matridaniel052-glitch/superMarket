...
def index():
    ...
    return render_template('products/index.html', products=all_products, categories=categories, search=search, selected_cat=category_id)
...
def add():
    ...
    if request.method == 'POST':
        ...
        p = Product(
            name=name, barcode=barcode, category_id=category_id or None,
